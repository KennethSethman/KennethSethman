...
- **Software Engineering** — Designing and implementing efficient, maintainable systems
- **Cybersecurity** — Building secure applications with security-first principles
- **Full-Stack Development** — End-to-end development from frontend interfaces to backend infrastructure
